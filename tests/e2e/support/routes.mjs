export const PRODUCTION_ROUTES = Object.freeze([
  ...
  },
  {
    ...
    htmlEntry: 'forgot-password.html',
    title: 'Reset Password | Dominion',
    access: 'public',
    defaultState: 'guest',
    ready: '#passwordRecoveryRequestForm',
    surfaces: ['navigation', 'forms', 'error'],
  },
  {
    id: 'resetPassword',
    path: '/reset-password.html',
    htmlEntry: 'reset-password.html',
    title: 'Choose New Password | Dominion',
    access: 'public',
    defaultState: 'guest',
    ready: '#passwordResetForm',
    surfaces: ['navigation', 'forms', 'error'],
  },
  {
    id: 'invite',
  ...
  },
  {
    id: 'privacy',
    path: '/privacy.html',
    htmlEntry: 'privacy.html',
    title: 'Privacy | Dominion',
    access: 'public',
    defaultState: 'guest',
    ready: 'main.legal-shell h1',
    surfaces: ['navigation', 'marketing'],
  },
  {
    id: 'terms',
    path: '/terms.html',
    htmlEntry: 'terms.html',
    title: 'Terms | Dominion',
    access: 'public',
    defaultState: 'guest',
    ready: 'main.legal-shell h1',
    surfaces: ['navigation', 'marketing'],
  },
  {
    ...
    path: '/cancellation-refunds.html',
    htmlEntry: 'cancellation-refunds.html',
    title: 'Cancellation and Refunds | Dominion',
    access: 'public',
    defaultState: 'guest',
    ready: 'main.legal-shell h1',
    surfaces: ['navigation', 'marketing'],
  },
  {
    id: 'support',
    path: '/support.html',
    htmlEntry: 'support.html',
    title: 'Support | Dominion',
    access: 'public',
    defaultState: 'guest',
    ready: 'main.legal-shell h1',
    surfaces: ['navigation', 'actions'],
  },
]);
