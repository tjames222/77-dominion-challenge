...
const BASE_BADGES = Object.freeze([
  {
    key: 'faithful_start',
    name: 'Faithful Start',
...
const BASE_POSTS = Object.freeze([
  {
    id: 'post_e2e_global',
    authorId: 'member_e2e_micah',
    name: 'Micah Reed',
    avatarUrl: '',
    crewId: null,
    scope: 'global',
    body: 'Day fourteen: the walk happened before the excuses arrived.',
    imagePath: null,
    imageUrl: '',
    imageAlt: '',
    postType: 'message',
  ...
  },
  {
    ...
    crewId: 'crew_e2e_alpha',
    scope: 'crew',
    body: 'Prayer first, then the rest of the standard.',
    imagePath: null,
    imageUrl: '',
    imageAlt: '',
    postType: 'message',
...
function baseMemberJson() {
  return {
    ...
    'dominion:mockCommunityPosts': json(BASE_POSTS),
