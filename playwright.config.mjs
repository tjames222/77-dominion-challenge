...
const alternateThemeId = String(process.env.E2E_ALT_THEME_ID || '').trim();
...
if (alternateThemeId) {
  themes.push({
    id: alternateThemeId,
    colorScheme: String(process.env.E2E_ALT_THEME_COLOR_SCHEME || 'dark'),
    alternate: true,
  });
}
...
const visualProjects = breakpoints.flatMap((breakpoint) => themes.map((theme) => ({
  ...
  metadata: {
    ...
    alternateTheme: Boolean(theme.alternate),
  },
  use: {
    ...breakpoint.use,
    colorScheme: theme.colorScheme,
  ...
  webServer: process.env.E2E_BASE_URL
    ...
    : {
        ...
        env: {
          ...
          VITE_ENABLE_ALTERNATE_THEME: alternateThemeId ? 'true' : 'false',
          VITE_ALTERNATE_THEME_ID: alternateThemeId,
        },
      },
  projects: [
    {
