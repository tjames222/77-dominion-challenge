-- Sanitized, deterministic reconstruction of the audited prelaunch source.
--
-- Schema source: commit 114ba5:supabase/schema.sql.
-- Gamification overlay and migration-3-equivalent helpers:
-- commit 89b0e32. Transaction wrappers are intentionally omitted because
...
-- migration-2 overlay from 89b0e32 follows --
...
-- migration-3-equivalent helper definitions from 89b0e32 follow --
...
-- Stable synthetic data proves that reconciliation preserves application rows.
insert into auth.users (
  ...
  'authenticated',
  'authenticated',
  'baseline-rehearsal@example.test',
  '$2b$10$K7L1OJ45/4Y2nIvhRVpCe.FSmR/cQF.iUFamQdki4.8/pK1gRgg7S',
  '2026-08-13 12:00:00+00',
  '{"provider":"email","providers":["email"]}'::jsonb,
  '{"name":"Baseline Rehearsal"}'::jsonb,
  '2026-08-13 12:00:00+00',
  '2026-08-13 12:00:00+00'
);
insert into public.profiles (
  user_id, name, email, challenge_start_date, created_at, updated_at
) values (
  '90000000-0000-4000-8000-000000000009',
  'Baseline Rehearsal',
  'baseline-rehearsal@example.test',
...
insert into public.entitlements (
  user_id, entitlement_key, status, source_type, source_id, starts_at,
